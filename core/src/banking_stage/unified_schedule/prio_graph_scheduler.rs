...
use crate::banking_stage::{scheduler_messages::BundleConsumeWork, unified_schedule::unified_scheduling_unit::UnifiedSchedulingUnit};
...
pub(crate) struct PrioGraphScheduler<Tx> {
    ...
    bundle_work_sender: Option<Sender<crate::banking_stage::scheduler_messages::BundleConsumeWork>>,
}
